...
The GitHub Actions workflow runs the application checks, validates the scenario inventory and checks these saved results. Open **Actions → Demo checks and recorded Rook evidence** to see the summary and download the evidence.
