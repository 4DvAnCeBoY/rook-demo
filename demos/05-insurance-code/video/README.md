...
The local video is delivered separately as `delivery/insurance-agent-code/insurance-agent-code.mp4`, with a matching SRT. Media files are excluded from Git. Rook product scenes use the hosted web UI. Presentation cards contain the explanatory diagrams.
