...
The local video is delivered separately as `delivery/customer-support-agent-code/customer-support-agent-code.mp4`, with a matching SRT. Media files are excluded from Git. Rook product scenes use the hosted web UI. Presentation cards contain the explanatory diagrams.
