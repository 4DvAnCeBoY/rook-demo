...
The local video is `delivery/customer-support-agent/customer-support-agent.mp4`. Audio uses ElevenLabs’ Vanishree — Energetic Indian English voice. The media files and credentials stay outside Git.
