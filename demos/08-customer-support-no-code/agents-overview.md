...
Juniper Goods · QE demonstration
...
Open **http://127.0.0.1:4317** after starting demo customer-support-agent. Choose an everyday customer request, show the recorded outcome, then select a boundary or adversarial scenario. Compare the original and updated agent then test in Rook’s interactive TUI and inspect the matching run in its hosted Web UI.
