...
Northstar Bank · Developer demonstration
...
Open **http://127.0.0.1:4310** after starting demo banking-agent-code. Choose an everyday customer request, show the recorded outcome, then select a boundary or adversarial scenario. Compare the original and updated agent then test in Rook’s interactive TUI and inspect the matching run in its hosted Web UI.
