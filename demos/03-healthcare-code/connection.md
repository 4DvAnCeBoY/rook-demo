...
Target: Patient Access Assistant. Base URL: http://127.0.0.1:4312. The facilitator configures this demo as described in README.md, supplying MODEL_API_KEY through .env or the OS environment, then starts the Node 22+ service with `npm run demo -- healthcare-agent-code` from the repository root.
