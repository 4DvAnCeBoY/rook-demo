...
The local video is `delivery/healthcare-agent-code/healthcare-agent-code.mp4`. Audio uses ElevenLabs’ Vanishree — Energetic Indian English voice. The media files and credentials stay outside Git.
