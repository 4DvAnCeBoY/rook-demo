...
if (!projectId || !/^[A-Za-z0-9-]+$/.test(projectId)) throw new Error('Select a Rook project first: run rook project create "Rook Customer Demos" or rook project use <id> from the demo folder or repository root, then retry. No project ID is needed in .env.');
